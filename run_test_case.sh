...
$UNITY_CMD_PATH -quit -batchmode -projectPath $UNITY_PROJECT_PATH -buildTarget iPhone -executeMethod Build.ClientBuilder.BuildClient_BatchMode -phase=CI -outputDir=$OUTPUT_DIR/build_step_1/
echo "      Result: " $?
...
$UNITY_CMD_PATH -quit -batchmode -projectPath $UNITY_PROJECT_PATH -buildTarget iPhone -executeMethod Build.ClientBuilder.BuildClient_BatchMode -phase=CI -outputDir=$OUTPUT_DIR/build_step_3/
echo "      Result: " $?
...
$UNITY_CMD_PATH -quit -batchmode -projectPath $UNITY_PROJECT_PATH -buildTarget iPhone -executeMethod Build.ClientBuilder.BuildClient_BatchMode -phase=CI -outputDir=$OUTPUT_DIR/build_step_4/
echo "      Result: " $?
